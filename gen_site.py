...
<meta name="description" content="Don Gorreone. Gorras, gorros y accesorios. Stock real, envíos a todo el país. Una oferta que no podés rechazar.">
<link rel="icon" href="logo_1080.png">
<meta property="og:title" content="Don Gorreone">
...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;700;900&family=Playfair+Display:ital,wght@0,700;0,900;1,700;1,900&family=Archivo:wght@400;500;600;700;800&family=Space+Mono:wght@400;700&display=swap" rel="stylesheet">
<style>
  :root{
    --paper:#0b0b0d; --paper2:#131214; --card:#151318;
    --ink:#e7dcc0; --ink2:#b6aa8c; --mut:#8a7f63;
    --red:#c9a24b; --gold:#c9a24b; --green:#5bbf86; --danger:#b3122a;
    --line:#2c2820; --imgbg:#efe7d4;
  }
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  /* grano */
  body::before{
    content:"";position:fixed;inset:0;z-index:1;pointer-events:none;opacity:.04;mix-blend-mode:screen;
  ...
  .brand{line-height:1}
  .brand .t{font-family:'Cinzel',serif;font-weight:900;font-size:22px;letter-spacing:1px;text-transform:uppercase;color:var(--ink)}
  ...
  .herologo{width:280px;flex:none;border:2px solid var(--gold);display:block;background:#0a0a0a}
  .hero h1{font-family:'Cinzel',serif;font-weight:900;font-size:clamp(40px,8vw,86px);line-height:.92;text-transform:uppercase;letter-spacing:1px;color:var(--ink)}
  .hero h1 .red{color:var(--gold)}
  .brandline{font-family:'Playfair Display',serif;font-style:italic;font-weight:700;font-size:clamp(16px,2.4vw,26px);letter-spacing:1px;color:var(--gold);margin-top:14px;line-height:1.1}
  ...
  .ph{aspect-ratio:1;position:relative;overflow:hidden;border-bottom:2px solid var(--line);background:var(--imgbg);padding:14px}
  .ph img{width:100%;height:100%;object-fit:contain;display:block;transition:transform .4s;mix-blend-mode:multiply}
  ...
  .stamp span{font-family:'Cinzel',serif;font-weight:900;font-size:24px;letter-spacing:2px;color:var(--danger);border:3px solid var(--danger);padding:5px 14px;transform:rotate(-11deg);opacity:.85;text-transform:uppercase;background:rgba(255,255,255,.4)}
  ...
  .nm{font-family:'Archivo';font-weight:700;font-size:14px;line-height:1.22;text-transform:uppercase;min-height:34px;color:var(--ink)}
  .row{display:flex;align-items:baseline;justify-content:space-between;gap:8px;border-top:1.5px dashed var(--line);padding-top:9px;margin-top:2px}
  .pr{font-family:'Cinzel',serif;font-weight:900;font-size:24px;line-height:1;color:var(--gold)}
  ...
  .buy{margin-top:auto;background:var(--gold);color:#0a0a0a;border:2px solid var(--gold);padding:11px;font-family:'Space Mono',monospace;font-weight:700;font-size:12.5px;letter-spacing:1px;text-transform:uppercase;cursor:pointer;text-decoration:none;text-align:center;display:flex;align-items:center;justify-content:center;gap:8px;transition:.12s}
  .buy:hover{background:#e3c074;border-color:#e3c074}
  .buy svg{width:15px;height:15px;fill:currentColor}
  .buy.dis{background:transparent;color:var(--mut);border-color:var(--line);cursor:not-allowed;pointer-events:none}
  /* footer */
  footer{border-top:2px solid var(--gold);background:#080809;color:var(--ink);margin-top:34px;position:relative;z-index:2}
  ...
  .fwrap .fb{font-family:'Cinzel',serif;font-weight:900;font-size:28px;text-transform:uppercase;color:var(--ink)}
  .fwrap .fb em{font-style:normal;color:var(--gold)}
  .fwrap .pay{font-family:'Space Mono',monospace;font-size:11px;letter-spacing:1px;color:var(--ink2);text-transform:uppercase;text-align:right;line-height:1.9}
  .proto{background:var(--gold);color:#0a0a0a;font-family:'Space Mono',monospace;font-size:11px;text-align:center;padding:6px;letter-spacing:.5px;position:relative;z-index:2;border-bottom:2px solid var(--line)}
...
<header>
  <div class="hwrap">
    <a class="crest" href="#top">
      <div class="mark"><img src="logo_1080.png" alt="DG"></div>
      <div class="brand"><div class="t">Don <em>Gorreone</em></div><div class="s">Gorras · Buenos Aires</div></div>
    </a>
    <div class="search">
...
<section class="hero" id="top">
  <div class="herotext">
  <h1>DON<br><span class="red">GORREONE</span></h1>
  <div class="brandline">Una oferta que no podés rechazar.</div>
  <div class="lead">
    <p>Gorras, gorros y accesorios. Fútbol, autos, motos, NBA y más. Stock real, sin vueltas — lo pedís por WhatsApp y listo.</p>
    <div class="stats">
  ...
  <img class="herologo" src="logo_1080.png" alt="Don Gorreone" width="280" height="280">
</section>
...
<footer>
  <div class="fwrap">
    <div class="fb">Don <em>Gorreone</em></div>
    <div class="pay">Transferencia · MercadoPago · QR<br>Envíos a todo el país · Retiro en CABA<br>WhatsApp +54 9 11 2399-4487<br><span style="color:var(--gold)">Catálogo actualizado: __UPDATED__ ART</span></div>
  </div>
</footer>
<script>
...
// ticker
const tk=["Envíos a todo el país","Pagá con MercadoPago","<b>Stock real</b> actualizado","Gorras · Gorros · Cuellos","Pedí por WhatsApp","<b>Don Gorreone</b>","una oferta que no podés rechazar"];
...
function waLink(p){
  const msg=`Hola Don Gorreone! Me interesa: ${p.nombre} (${fmt(p.precio)}). ${p.url}`;
